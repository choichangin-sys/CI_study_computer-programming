...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND : // 메뉴가 눌림.
    {
        ...
        {
        case ID_My_Save:
            MessageBox(hWnd, _T("저장합니다."), _T("나의 메뉴"), MB_OK);
            break;
        case ID_My_Print:
            MessageBox(hWnd, _T("인쇄합니다."), _T("나의 메뉴"), MB_OK);
            break;
        }
    }
    break;
    case WM_PAINT:
    {
        ...
        TCHAR str[256];// = _T("안녕하세요. 반가워요.");
        TextOut(hdc, 10, 10, str, lstrlen(str));
        LoadString(hInst, IDS_HELLO, str, 256);
        EndPaint(hWnd, &ps);
    }
    break;
    case WM_DESTROY:
