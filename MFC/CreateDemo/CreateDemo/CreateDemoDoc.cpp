...
CCreateDemoDoc::CCreateDemoDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CCreateDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CCreateDemoDoc::InitializeSearchContent()
{
...
void CCreateDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
BOOL CCreateDemoDoc::OnOpenDocument(LPCTSTR lpszPathName)
{
	...
	AfxMessageBox(lpszPathName); // 위치가 나옴.
	return TRUE;
}
