...
CEditDemoDlg::CEditDemoDlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(CEditDemoDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CEditDemoDlg::OnBnClickedButton1)
END_MESSAGE_MAP()


// CEditDemoDlg 메시지 처리기
...
void CEditDemoDlg::OnBnClickedButton1()
{
	...
	// 1. 에디트 창의 글자를 읽어온다.
	UpdateData(1); // 컨트롤에 적힌 것을 변수에 저장함. 
