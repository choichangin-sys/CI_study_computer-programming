...
void CGDIDemoView::OnPaint()
{
	...
	/*
	CPen YourPen;
	YourPen.CreatePen(PS_DASHDOTDOT, 10, RGB(0, 200, 0));
	CPen MyPen(PS_DASHDOTDOT, 20, RGB(200, 0, 0));
	CPen* pOldPen = dc.SelectObject(&MyPen);

	CDC
	//dc.Rectangle(150, 150, 300, 300);
