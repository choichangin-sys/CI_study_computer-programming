...
void CMouseDemoView::OnPaint()
{
	...
	/*
	View에서 LBDown이 눌렸을 때
	=> 안녕하세요. 방가워요. (X좌표), (Y좌표)가 나오게 만들어라.
	*/

	CString strTemp;
	strTemp.Format(_T("안녕하세요. 방가워요. %d, %d 입니다."), m_nX, m_nY);
