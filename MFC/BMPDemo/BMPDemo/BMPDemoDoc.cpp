...
// BMPDemoDoc.cpp: CBMPDemoDoc 클래스의 구현
//
...
CBMPDemoDoc::CBMPDemoDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CBMPDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CBMPDemoDoc::InitializeSearchContent()
{
...
void CBMPDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
